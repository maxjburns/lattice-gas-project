...
def particleDistribution(latticeList):
    ...
    while(particlesLeft != 0):
        ...
        site=random.randint(0,cell_number(containerSize, particleNumber) - 1) 
        ...
        if(entryAtSite.find('0')!=-1):
            ...
            particlesLeft -= 1 #exit condition
...
print("\n\nnew latticeList: "+ ' '.join(map(str, particleDistribution(the_categorizer(containerSize, particleNumber)))))
